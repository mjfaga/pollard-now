...
// Single-path brand glyphs (from Simple Icons) keyed by `platform` in
// lib/links.ts. Inline SVG keeps the icon set dependency-free.
...
const variantStyles: Record<Variant, string> = {
  ...
  onPrimary: "border-white/40 text-white hover:bg-white/10",
};
